...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Rocket> u1Phase1RocketList = simulation.loadU1(itemsPhase1);
        int u1BudgetPhase1 = simulation.runSimulation(u1Phase1RocketList);

        System.out.println("\n= = = = = Load a fleet of U1 rockets for Phase-2 = = = = =");
        ArrayList<Rocket> u1Phase2RocketList = simulation.loadU1(itemsPhase2);
        ...
        ArrayList<Rocket> u2Phase1RocketList = simulation.loadU2(itemsPhase1);
        int u2BudgetPhase1 = simulation.runSimulation(u2Phase1RocketList);

        System.out.println("\n= = = = = Load a fleet of U2 rockets for Phase-2 = = = = =");
        ArrayList<Rocket> u2Phase2RocketList = simulation.loadU2(itemsPhase2);
